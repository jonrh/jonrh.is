...
1. Download [this file](/other/getting-the-asus-usb-bt211-bluetooth-dongle-to-work-on-a-hackintosh/ath3k-firmware-uploader-V2.tar.gz)
(it's extracted Windows 7 drivers courtesy of the user *ajg0r* at the tonymacx86 forum)
