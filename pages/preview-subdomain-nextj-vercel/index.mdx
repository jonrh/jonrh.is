...
>
  ...
  latest changes when using Next.js and Vercel. Examples:
  ...
  4. Adds noindex HTTP header to `preview` deployments.
  5. Returns correct `robots.txt` for production and previews.
