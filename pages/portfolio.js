...
const Portfolio = () => {
  return (
    <Layout>
      ...
      <ul>
        <li>
          <a href="#timavera">Tímavera</a>
        </li>
        <li>
          <a href="#websitesemail">Websites & Email for Contractors</a>
        </li>
        <li>
          <a href="#tinycrm">Tiny CRM</a>
        </li>
        <li>
          <a href="#activitystream">Activity Stream</a>
        </li>
        <li>
          <a href="#bd-monitor">Vaki: mobile dashboard app</a>
        </li>
        <li>
          <a href="#biomass-daily">Vaki: web dashboard</a>
        </li>
        <li>
          <a href="#ja-gadget-widget">Já.is: Widget & Gadget</a>
        </li>
      </ul>
      ...
      <p>
        ...
        JavaScript and React Native. Website with React. Python & Flask API. Set
        up continuous deployments with CircleCI & Docker.{" "}
      ...
      <p>
        ...
        to be an intermediate CRM for those that need something better than a
        text docu&shy;ment or a spreadsheet but something simpler and more
        lightweight than the established CRMs. See more at{" "}
        <a href="https://tinycrm.app">tinycrm.app</a>. Currently in the very
        early days. If interested to try it out send us a line at{" "}
      ...
      <p>
        ...
        of the Year in 2017 and AI/ML Startup of the Year in 2018. Created and
        maintained dashboards and visualisations for the AI engine. JavaScript,
        TypeScript & Mithril. Remote contractor.{" "}
      ...
      <p>
        ...
        <a href="https://vakiiceland.is/biomass-daily/">Biomass Daily</a>{" "}
        system. A company operating salmon farms would rent hardware frames from
        Vaki and place them in the sea cages. As the salmon swim through the
        frames their weight is measured. This data is then aggregated and
      ...
      <p>
        ...
        who are often on the move. Product development from sketches all the way
        to a finished mobile app.
      </p>
      ...
      <ul>
        <li>
          <strong>Dashboard</strong> of current operational status of hardware
          in the field.
        </li>
        <li>
          <strong>Trend analysis</strong> of weight data to see how population
          is progressing.
        </li>
        <li>
          <strong>Distribution</strong> analysis to observe weight distribution
          and health of population.
        </li>
        <li>
          <strong>Administration</strong> section to manage users and
          privileges.
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a href="http://jonrh.is/retrospective-on-react/">
            Retrospective on React
          </a>
          .
        </li>
        <li>
          <strong>Backend</strong> provides all data through a web service API
          and JSON. Written and maintained by Vaki in C# and Microsoft SQL
          Server database.
        </li>
      </ul>
      ...
      <p>
        ...
        and{" "}
        <a href="https://en.wikipedia.org/wiki/Windows_Desktop_Gadgets">
          Windows Gadget
        </a>{" "}
