    ...
    return (
      <div>
        ...
        <ul>
          ...
          <li>Available for contract work in mid September 2017.</li>
          <li>Currently working on two iOS and Android mobile dashboards written in React Native.</li>
          <li>Very interested in functional programming: ReasonML, Elm, PureScript, Haskell, etc.</li>
        ...
        <p>
          ...
          I help companies create bespoke dashboards their customers want to use. Essentially I
          take care of the frontend while your company can focus on a good backend. We will be a
          good fit if you:
        </p>
        ...
        <ul>
          ...
          <li>Have a good idea what your KPIs are.</li>
